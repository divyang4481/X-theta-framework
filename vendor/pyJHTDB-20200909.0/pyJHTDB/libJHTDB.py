...
#            return 0
    ...
    def getData(self,
        ...
        if make_modulo:
            pcoords = np.zeros(point_coords.shape, float64)
    ...
    def getbigCutout(
        ...
        for field in fields:
            ...
            for time_step in np.arange(t_start, t_end+1, t_step):
                ...
                result=np.zeros((nnz,nny,nnx,dim),dtype='np.float32')
    ...
    def getThreshold(
        ...
        call_result = self.lib.getThreshold(
                ...
                ctypes.c_np.int32(sinterp),
                ctypes.c_np.int32(x_start),
                ctypes.c_np.int32(y_start),
                ctypes.c_np.int32(z_start),
                ctypes.c_np.int32(x_end),
                ctypes.c_np.int32(y_end),
                ctypes.c_np.int32(z_end),
                ctypes.byref(result),
