...
\input{sections/05_qm_gr_conflicts} % Classic Puzzles & Open Problems
\input{sections/09_related_work} % Related Work & Originality
\input{sections/02_framework} % The X-theta Framework
\input{sections/04_analogies} % Analogies
\input{sections/03_math_formalism} % Math Formalism
\input{sections/06_theory_predictions} % Predictions
\input{sections/07_experiments} % Experiments
