...
"""
weihs_topology_lab_v12.py

THE VERIFIER.
Identical to v11, but adds the --null-shuffle flag to perform the Null Test.

USAGE:
  1. PHYSICS RUN:
     python src/weihs_topology_lab_v12.py --alice-zip "..\Alice.zip" --bob-zip "..\Bob.zip" --folder longdist --reverse-bits

  2. NULL TEST (The Skeptic):
     python src/weihs_topology_lab_v12.py ... --null-shuffle


     python .\weihs_topology_lab_v12.py   --alice-zip "..\Bell_data\7185335\Alice.zip"   --bob-zip   "..\Bell_data\7185335\Bob.zip"   --folder longdist   --reverse-bits   --null-shuffle
"""
...
def main():
    ...
    parser.add_argument("--null-shuffle", action="store_true", help="Randomize outcomes to kill physics")
    
    args = parser.parse_args()
    
    print(f"\n=== X-THETA LAB v12 (Verification) ===")
    if args.null_shuffle:
        print("MODE: NULL TEST (Outcomes Shuffled)")
    else:
        print("MODE: PHYSICS RUN (Real Data)")
