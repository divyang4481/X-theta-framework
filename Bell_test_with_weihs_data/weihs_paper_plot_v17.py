#!/usr/bin/env python3
"""
weihs_paper_plot_v17.py

THE RIGOROUS PLOTTER.
Updates from v16:
1. STRICT BINNING: Drops phase bins if any setting pair (00,01,10,11) has low stats (<20).
   Prevents artificial inflation of S due to missing subtraction terms.
2. ROBUST BOOTSTRAP: Increases resamples to 2000 for stable error bars.
3. CORRECTS MATH: Explicitly treats Theta as a Loop Holonomy (updates on cycles).
"""
...
# === CONFIG ===
RESONANCE_KAPPA = 0.8  # Validated Split-Half Result
BOOTSTRAP_ROUNDS = 2000
MIN_COUNTS_PER_SETTING = 20 # Critical for validity
...
def calculate_S_robust(bin_outcomes, rounds=2000):
    ...
    for k in range(4):
        if len(bin_outcomes[k]) < MIN_COUNTS_PER_SETTING:
            return None, None
...
def main():
    ...
    print("Processing for Rigorous Plot...")
    ...
    plt.savefig("weihs_paper_plot_v17.png")
    print("\nSaved: weihs_paper_plot_v17.png")
