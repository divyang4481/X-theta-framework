...
% Use ragged-right p-columns to reduce underfull hboxes in narrow columns
...
\midrule
Extra structure & 1D \emph{fiber} angle $\theta$ over spacetime; lab\textendash{} programmable loop phase & Extra spatial dimensions compactified (fixed geometry) & 10D/11D with compactification; rich moduli \\
