...
\subsection{$\theta$--AB phase under null spatial fields}\label{sec:theta-ab}
...
\subsection{Order-of-magnitude anchors for $I$}\label{sec:iom}
...
\subsection{Methods: $\theta$--Aharonov--Bohm interferometer}\label{sec:methods-theta-ab}
...
\subsection{Mesoscopic Transport: AB Rings with a $\theta$-Flux Offset}\label{sec:mesoscopic}
