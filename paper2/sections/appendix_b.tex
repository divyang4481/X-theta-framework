...
\begin{description}
  \item[Loop-phase response (transport phase)] Loop-induced phase from parallel transport around a closed loop:
  \[
    \Delta\theta_{\mathrm{loop}}(\gamma)\equiv -\kappa\oint_\gamma A\ (\bmod\ 2\pi).
  \]
  \begin{itemize}
